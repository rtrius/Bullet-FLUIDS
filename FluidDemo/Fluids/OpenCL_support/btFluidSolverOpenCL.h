...
*/
#ifndef BT_FLUID_SOLVER_OPENCL_H
#define BT_FLUID_SOLVER_OPENCL_H
...
class btFluidSolverOpenCL : public btFluidSolver
{
	...
	btOpenCLArray<btFluidParametersGlobal> m_globalFluidParams;
