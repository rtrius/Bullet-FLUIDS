...
public:
	...
	void render(const btAlignedObjectArray<btVector3> &particlePositions, float sphereRadius, float r, float g, float b);
...
private:
	...
	void render_stage3_generateSurfaceTexture();
	void renderFullScreenTexture(GLuint texture2d_0, GLuint texture2d_1);
